                    ...
                    <div class="relative px-4 w-full max-w-2xl h-full md:h-auto">
                        ...
                        <div class=" relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="flex justify-between items-start p-3 rounded-t border-b dark:border-gray-600">
                                <h3 class="text-2xl font-semibold text-gray-900 lg:text-3xl dark:text-white">
                            ...
                            <div class="p-4 space-y-2">
                                <p class="text-xl leading-relaxed text-gray-500 dark:text-gray-400">
                                    I'm Elliot Henriquez and I create interactive web presences for clients. With WebWorld Wonders, I aim to engage users with imaginative online experiences. UX design and development is what I currently focus for each and every wonder. 
                                </p>
                            </div>
                            <!-- Modal footer -->
                            <div class="flex items-center p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                                <button type="button" class="text-white bg-theme hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">View Resume</button>
